...
function ifs_mp_leaderboard_Listbox_CreateItem(layout)
	...
	Temp.rankfield = NewIFText{ clip = "character", x = 10, y = 0, textw = text_width, halign = "left", font = "gamefont_small", nocreatebackground = 1,}
...
--	Temp.titlefield = NewIFText{ clip = "character", x = Temp.levelfield.textw, y = 0, textw = 60, halign = "left", font = "gamefont_small", nocreatebackground = 1,}
	Temp.namefield = NewIFText{ clip = "character", x = layout.width * 0.5 - 200, y = 0, textw = 400, halign = "hcenter", font = "gamefont_small", nocreatebackground = 1,}
	Temp.ratingfield = NewIFText{ clip = "character", x = layout.width - text_width - 10, y = 0, textw = text_width, halign = "right", font = "gamefont_small", nocreatebackground = 1,}
	return Temp
end
...
--	{ labelustr = " Favorite Vehicle", contentsustr = "AT-ST"}, 
	...
	{ rankfield = "1234567890", levelfield = "1", titlefield = "", namefield = "sammy davis", ratingfield = "1234567890" },
