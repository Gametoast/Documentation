ParticleEmitter("LaserBeam")
{
	...
	Spawner()
	{
		...
		Offset()
		{
			...
			PositionY(2.0700,2.7000);
			PositionZ(-0.0100,0.0100);
		}
		PositionScale(0.0000,0.0000);
		VelocityScale(10.0000,10.0000);
		InheritVelocityFactor(0.0000,0.0000);
		Size(0, 0.1250, 0.2250);
		Hue(0, 200.0000, 220.0000);
		Saturation(0, 20.0000, 20.0000);
		Value(0, 255.0000, 255.0000);
		Alpha(0, 255.0000, 255.0000);
		StartRotation(0, 0.0000, 360.0000);
		RotationVelocity(0, -80.0000, 100.0000);
		FadeInTime(0.0000);
	}
	Transformer()
	{
