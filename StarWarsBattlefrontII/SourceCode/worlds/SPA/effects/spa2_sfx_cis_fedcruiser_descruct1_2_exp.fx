	...
	ParticleEmitter("Shockwave")
	{
		...
		ParticleEmitter("Explosion")
		{
			...
			Spawner()
			{
				...
				VelocityScale(40.0000,80.0000);
				InheritVelocityFactor(50.0000,50.0000);
				Size(0, 15.8813, 31.7625);
				Red(0, 255.0000, 255.0000);
				Green(0, 255.0000, 255.0000);
				Blue(0, 255.0000, 255.0000);
			...
			Geometry()
			{
				...
				ParticleEmitter("Smoke")
				{
					...
					Spawner()
					{
						...
						PositionScale(0.0000,0.0000);
						VelocityScale(7.9406,7.9406);
						InheritVelocityFactor(0.2500,0.2500);
						Size(0, 7.2188, 9.6250);
						Hue(0, 0.0000, 0.0000);
					...
					ParticleEmitter("Flare")
					{
						...
						ParticleEmitter("Embers")
						{
							...
							Spawner()
							{
								...
								VelocityScale(9.6250,19.2500);
								InheritVelocityFactor(50.0000,50.0000);
								Size(0, 14.4375, 28.8750);
								Red(0, 255.0000, 255.0000);
							...
							ParticleEmitter("Sparks")
							{
								...
								Spawner()
								{
									...
									VelocityScale(25.0000,50.0000);
									InheritVelocityFactor(50.0000,50.0000);
									Size(0, 0.2406, 0.7219);
									Red(0, 255.0000, 255.0000);
									Green(0, 255.0000, 255.0000);
									Blue(0, 255.0000, 255.0000);
