...
--This is all the flag capture objective stuff
	...
	AddAIGoal(REP, "Defend", 30, "gatepanel")
	AddAIGoal(CIS, "Destroy", 30, "gatepanel")
	AddAIGoal(CIS, "Destroy", 10, "woodl")
	AddAIGoal(CIS, "Destroy", 10, "woodc")
	AddAIGoal(CIS, "Destroy", 10, "woodr")
	AddAIGoal(REP, "Defend", 10, "woodl")
	AddAIGoal(REP, "Defend", 10, "woodc")
	AddAIGoal(REP, "Defend", 10, "woodr")
...
function ScriptInit()
    ...
    SetupTeams{
        ...
        rep={
            ...
            units = 160,
            reinforcements = -1,
            soldier = {"rep_inf_ep3_rifleman",10, 40},
            assault = {"rep_inf_ep3_rocketeer",1, 30},
            engineer = {"rep_inf_ep3_engineer",1, 30},
            sniper  = {"rep_inf_ep3_sniper_felucia",1, 20},
            officer = {"rep_inf_ep3_officer",1, 20},
            special = {"rep_inf_ep3_jettrooper",1, 20},
        ...
        cis={
            ...
            units = 160,
            reinforcements = -1,
            soldier = {"cis_inf_rifleman",10, 40},
            assault = {"cis_inf_rocketeer",1, 30},
            engineer = {"cis_inf_engineer",1, 30},
            sniper  = {"cis_inf_sniper",1, 20},
            officer   = {"cis_inf_officer",1, 20},
            special = {"cis_inf_droideka",1, 20},
        }
    }
    ...
    --  Level Stats
    ClearWalkers()
    AddWalkerType(0, 8) -- 4 droidekas (special case: 0 leg pairs)
    AddWalkerType(1, 0) --
