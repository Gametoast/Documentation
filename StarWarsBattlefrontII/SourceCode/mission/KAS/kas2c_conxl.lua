...
--                             "cis_walk_spider",
    ...
    SetupTeams{
        ...
        cis={
            ...
            units = 64,
            reinforcements = 150,
            soldier = {"cis_inf_rifleman",15, 45},
            assault = {"cis_inf_rocketeer",3, 6},
            engineer = {"cis_inf_engineer",3, 6},
            sniper  = {"cis_inf_sniper",3, 6},
            officer   = {"cis_inf_officer",3, 6},
            special = {"cis_inf_droideka",3, 6},
        }
    }
