...
--Ambush Teams true
    ...
    AddUnitClass(rebels1, "all_inf_rifleman_snow", 20)
    AddUnitClass(rebels1, "all_inf_rocketeer_snow", 20)
    AddUnitClass(rebels1, "all_inf_engineer_snow", 20)
    AddUnitClass(rebels1, "all_inf_sniper_snow", 20)
    ...
    AddUnitClass(rebels2, "all_inf_rifleman_snow", 20)
    AddUnitClass(rebels2, "all_inf_rocketeer_snow", 20)
    AddUnitClass(rebels2, "all_inf_engineer_snow", 20)
    AddUnitClass(rebels2, "all_inf_sniper_snow", 20)
    ...
    AddWalkerType(2, 4) -- 2 atats with 2 leg pairs each
