...
function ScriptInit()
    ...
    SetupTeams{
        ...
        all={
            ...
            units = 120,
            reinforcements = -1,
            soldier = {"all_inf_rifleman_snow",9, 30},
            assault = {"all_inf_rocketeer_snow",1, 20},
            engineer   = {"all_inf_engineer_snow",1, 20},
            sniper  = {"all_inf_sniper_snow",1, 10},
            officer = {"all_inf_officer_snow",1, 20},
            special = {"all_inf_wookiee_snow",1, 20},
        ...
        imp={
            ...
            units = 120,
            reinforcements = -1,
            soldier = {"imp_inf_rifleman_snow",9, 30},
            assault = {"imp_inf_rocketeer_snow",1, 20},
            engineer   = {"imp_inf_engineer_snow",1, 20},
            sniper  = {"imp_inf_sniper_snow",1, 10},
...
--Setting up Heros--
  ...
  SetMemoryPoolSize("OrdnanceTowCable", 40) -- !!!! need +4 extra for wrapped/fallen cables !!!!
    ...
    ReadDataFile("HOT\\hot1.lvl", "hoth_XL")
