...
SetHistorical()
    ...
    AddMissionObjective(CIS, "orange", "level.kas2.objectives.1h");
    AddMissionObjective(CIS, "red", "level.kas2.objectives.2h");
    AddMissionObjective(REP, "orange", "level.kas2.objectives.1h");
    AddMissionObjective(REP, "red", "level.kas2.objectives.3h");
  ...
  SetEnemyTeamDifficultyMedium (1)
