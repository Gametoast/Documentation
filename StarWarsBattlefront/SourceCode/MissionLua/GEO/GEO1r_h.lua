...
--  Sound
    ...
    SetAmbientMusic(REP, 0.5, "rep_GEO_amb_middle", 1,1)
    SetAmbientMusic(REP, 0.25,"rep_GEO_amb_end",    2,1)
    SetAmbientMusic(CIS, 1.0, "cis_GEO_amb_start",  0,1)
    SetAmbientMusic(CIS, 0.5, "cis_GEO_amb_middle", 1,1)
    SetAmbientMusic(CIS, 0.25,"cis_GEO_amb_end",    2,1)
