...
--  Alliance Stats
    ...
    AddUnitClass(ALL, "all_inf_soldierjungle",2)
    AddUnitClass(ALL, "all_inf_vanguardjungle",2)
    AddUnitClass(ALL, "all_inf_pilot",16)
    AddUnitClass(ALL, "all_inf_marksmanjungle",1)
...
--  Imperial Stats
    ...
    AddUnitClass(IMP, "imp_inf_storm_trooper",2)
    AddUnitClass(IMP, "imp_inf_shock_trooper",2)
    AddUnitClass(IMP, "imp_inf_pilottie",16)
...
--  Sound
   ...
   OpenAudioStream("sound\\cor.lvl",  "bes1gcw");
   --OpenAudioStream("sound\\cor.lvl",  "bes1gcw_emt");
