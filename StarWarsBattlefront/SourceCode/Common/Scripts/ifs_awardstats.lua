...
ifs_awardstats = NewIFShellScreen {
	...
	Enter = function(this, bFwd)
		...
		for i=1,8 do
			...
			local omega = 20
			if(random()<0.5) then omega = -omega end
			ScriptCB_IFModel_SetOmegaY(this.IconModels[i].model.cpointer,omega)
...
--	end
	...
	AwardStats_listbox_layout.showcount = floor(h / (AwardStats_listbox_layout.yHeight + AwardStats_listbox_layout.ySpacing)) - 1
