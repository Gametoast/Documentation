...
--		ifs_opt_pckeyboard_CreateListboxContents(ifs_opt_pckeyboard_listbox_contents);
...
function ifs_opt_pckeyboard_fnInitScreen(this)
	...
	ifs_opt_pckeyboard_listbox_layout.showcount = floor(h / (ifs_opt_pckeyboard_listbox_layout.yHeight + ifs_opt_pckeyboard_listbox_layout.ySpacing)) - 1
