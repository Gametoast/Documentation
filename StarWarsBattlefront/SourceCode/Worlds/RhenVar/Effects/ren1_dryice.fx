ParticleEmitter("DryIce")
{
	...
	Spawner()
	{
		...
		StartRotation(0, -10.0000, 0.0000);
		RotationVelocity(0, -10.0000, 0.0000);
		FadeInTime(0.0000);
	}
	Transformer()
	{
		...
		{
			LifeTime(1.0000)
			Reach(200.0000,200.0000,200.0000,24.0000);
			Next()
			{
				LifeTime(7.0000)
				Reach(200.0000,200.0000,200.0000,0.0000);
			}
		}
	}
	Geometry()
