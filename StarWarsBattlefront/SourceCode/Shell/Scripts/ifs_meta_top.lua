...
function ifs_meta_top_fnHilightSide(this)
	...
	for i = 1,getn(ifs_meta_top_IconNames) do
...
ifs_meta_top = NewIFShellScreen {
	nologo = 1,
	movieIntro      = nil,
	movieBackground = "ifs_meta",

	bg_texture = HackBGTextureOnPCOnly("generic3_screen"),
...
--	},	
	...
	Enter = function(this, bFwd)
		...
		--	IFObj_fnSetVis( this.buttonWindowSp, 1 )
			
			IFObj_fnSetVis( this.subtitle, nil )
			--IFObj_fnSetVis( this.subtitleSp, 1 )
		else
...
--		gIFShellScreenTemplate_fnExit(this)
	...
	Update = function(this, fDt)
		...
		local r = random(100) -- spice up the random # generator
	end,
...
function ifs_meta_top_fnMakeIcons(this)
	...
	for i = 1,getn(ifs_meta_top_IconNames) do
		if(i==1 or i==3) then
			if(gPlatformStr == "PC") then
				IconWidth = w / getn(ifs_meta_top_IconNames) / 2
				XPos = IconWidth * -0.5
			else
