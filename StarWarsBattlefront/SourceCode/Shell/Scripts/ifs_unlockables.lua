...
--	},
	...
	Enter = function(this, bFwd)
		...
		local n = getn(ifs_unlockables_vbutton_layout.buttonlist)
		for i=1,n do 
...
--if(ScriptCB_GetLanguage() ~= "english") then
	...
	ifs_unlockables_vbutton_layout.width = 500 -- Made bigger for Spanish, other versions - NM 7/10/04
--end
