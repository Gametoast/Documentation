...
--	end
	...
	local LocalizedTeam,BattleAtStr

--	IFText_fnSetString(this.Team1Name,metagame_state.team1.teamname2)
--	IFText_fnSetString(this.Team2Name,metagame_state.team2.teamname2)

	local MapName = strsub(metagame_state.TrueMapName,1,4)

-- metagame_state.NextMapName

	local TargetPlanet = metagame_state.planets[metagame_state.pickplanet]
	local Map12Char = strsub(metagame_state.TrueMapName,4,4) -- 1 or 2
...
--	print("TargetName = ", TargetPlanet[MapExtension])
	...
	BattleAtStr = ScriptCB_usprintf("ifs.meta.battle.battlefor",LocalizedMapName)

--	TitleBarLabel_fnSetUString(this.Title.TitleBar,BattleAtStr)
--	IFImage_fnSetTexture(this.Title.SealL, "seal_" .. metagame_state.team1.shortname)
--	print("Texture 1 = ", "seal_" .. metagame_state.team1.shortname)
--	IFImage_fnSetTexture(this.Title.SealR, "seal_" .. metagame_state.team2.shortname)
--	print("Texture 2 = ", "seal_" .. metagame_state.team2.shortname)

	-- Update center map
--	print("True Map name = ",metagame_state.TrueMapName)
--	IFMapPreview_fnSetTexture(this.CenterItems.Map,"map_" .. strsub(metagame_state.TrueMapName,1,4))
	...
	if(((metagame_state_local.mJoystickTeams[1]==1) or (metagame_state_local.mJoystickTeams[1]==2)) and
	    ...
	    local localTeam1      = metagame_state[format("team%d", metagame_state_local.mJoystickTeams[1])]
	    local localTeam2      = metagame_state[format("team%d", metagame_state_local.mJoystickTeams[2])]
